...
void lenovo_charger_set_term2(void)
{
    if(lenovo_kpoc_flag == 1)
        bq24157_set_iterm((LENOVO_CHARGING_TERM_CUR_STAGE_2+1));
    else
...
//		bq24157_set_iterm(LENOVO_CHARGING_TERM_CUR_STAGE_2);
		lenovo_charger_set_term2();
	}
}
 
void lenovo_charging_term_reset_to_stage_2(int kpoc_flag)
{
	int en = KAL_TRUE;
	lenovo_kpoc_flag = kpoc_flag;
